        ...
        <Box className="Signup" >
            <Box className='SignupBox'>
                ...
                <Box className='alertBox'>
                    ...
                    {values.alertState==2?<Alert variant="filled" severity="warning" onClose={() => {setValues({...values, alertState : 0 })}}>비밀번호가 동일하지 않습니다!</Alert>:<span/>}
                    {values.alertState==3?<Alert variant="filled" severity="warning" onClose={() => {setValues({...values, alertState : 0 })}}>이미 존재하는 아이디 입니다!</Alert>:<span/>}
                    {values.alertState==4?<Alert variant="filled" severity="success" onClose={() => {setValues({...values, alertState : 0 })}}>회원가입 완료</Alert>:<span/>}
                </Box>
                <Box  className='singupButton'>
                    <Button onClick={()=>loginButton()} variant="contained" color="primary">확인</Button>
                </Box>
            </Box>
        </Box>
    )
