...
function Notice({ item }) {
    return (
        <Box style={{ display: 'flex', justifyItems: 'center', flexDirection: 'column', justifyContent: 'center', textAlign: 'center', width: '70px' }}>
            <Box marginBottom={1} style={{ fontSize: '20px', color: item.color, fontWeight: '600' }}>
                {item.value}
            </Box>
        ...
        <Box sx={{ p: 2, bgcolor: '#DDDDDD' }} className="Home">
            <Box sx={{ flexGrow: 1, mb: 1, display: 'flex', flexDirection: 'row', height: '20%' }}>
                <Box sx={{ display: 'flex', flexGrow: 1, mr: 1, flexDirection: 'row' }}>
                    <Box sx={{ py: 2, px: 2, width: '100%', color: '#ffff' }} bgcolor="#5E2F78">
                        demo
                    </Box>
                    <Box sx={{ py: 2, px: 2, ml: 1, width: '100%', color: '#ffff' }} bgcolor="#EBB14A">
                        demo
                    </Box>
                    <Box sx={{ py: 2, px: 2, ml: 1, width: '100%', color: '#ffff' }} bgcolor="#E1576B">
                        demo
                    </Box>
                </Box>
                <Box sx={{ flexGrow: 1 }}>
                            ...
                            <Grid item md={12}>
                                ...
                                <List>
                                    {Performancearry.map((item) => (
                                        <PerformanceLists key={item.text} text={item} />
                                    ))}
                                </List>
                            </Grid>
                        </Grid>
                            ...
                            <Grid item md={12}>
                                ...
                                <List>
                                    {LoginHistoryarry.map((item) => (
                                        <LoginHistoryLists key={item.id} no={item.id + 1} user={item.name} timestamp={item.timestamp} />
                                    ))}
                                </List>
                            </Grid>
                        </Grid>
                                        ...
                                        <Grid container spacing={0}>
                                            ...
                                            <Grid item md={3}>
                                                ...
                                                <Typography component="div">
                                                    <li>
                                                        <span>높은 역향</span> <span>0</span>
                                                    </li>
                                                    <li>
                                                        <span>중간 역향</span> <span>0</span>
                                                    </li>
                                                    <li>
                                                        <span>낮은 역향</span> <span>0</span>
                                                    </li>
                                                </Typography>
                                            </Grid>
                                        </Grid>
